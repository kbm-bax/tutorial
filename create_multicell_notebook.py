...
notebook = {
    "cells": [
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 3. Bronze Layer - Ingest Raw Data"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 4. Silver Layer - Clean and Enrich Data"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 5. Gold Layer - Aggregate for Analytics"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 6. Time Travel - Query Historical Data"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
...
# Write to file
with open('notebooks/pipeline_example_multicell.ipynb', 'w') as f:
    json.dump(notebook, f, indent=2)

print("✓ Multi-cell notebook created successfully!")